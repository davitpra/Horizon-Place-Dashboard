...
export interface ApiBreakfastBreakfast extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    complete: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDinnerDinner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dessert: Schema.Attribute.Boolean;
    Hotdrink: Schema.Attribute.Enumeration<['Coffee', 'Tea', 'none']>;
    Juice: Schema.Attribute.Enumeration<
      ['Tomato', 'Orange', 'Cramberry', 'Apple', 'none']
    >;
    ...
    Milk: Schema.Attribute.Enumeration<['none', 'regular', 'lactose free']>;
    onTray: Schema.Attribute.Boolean;
    option_1: Schema.Attribute.Boolean;
    option_2: Schema.Attribute.Boolean;
    publishedAt: Schema.Attribute.DateTime;
    side_1: Schema.Attribute.Boolean;
    side_2: Schema.Attribute.Boolean;
    side_3: Schema.Attribute.Boolean;
    side_4: Schema.Attribute.Boolean;
    slug: Schema.Attribute.UID<'Title'>;
    table: Schema.Attribute.Integer;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiLunchLunch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::lunch.lunch'> &
      Schema.Attribute.Private;
    menu: Schema.Attribute.Relation<'oneToOne', 'api::menu.menu'>;
    Milk: Schema.Attribute.Enumeration<['none', 'regular', 'lactose free']>;
    onTray: Schema.Attribute.Boolean;
    ...
    option_2: Schema.Attribute.Boolean;
    publishedAt: Schema.Attribute.DateTime;
    salad: Schema.Attribute.Boolean;
    slug: Schema.Attribute.UID<'Title'>;
    soup: Schema.Attribute.Boolean;
    table: Schema.Attribute.Integer;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiMenuScheduleMenuSchedule
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Breakfast: Schema.Attribute.Component<'meals.breakfast-especial', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Date: Schema.Attribute.Date & Schema.Attribute.Required;
    Dinner: Schema.Attribute.Component<'meals.dinner', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::menu-schedule.menu-schedule'
    > &
      Schema.Attribute.Private;
    Lunch: Schema.Attribute.Component<'meals.lunch', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    breakfast: Schema.Attribute.Relation<
      'oneToOne',
      'api::breakfast.breakfast'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::menu.menu'> &
      Schema.Attribute.Private;
    lunch: Schema.Attribute.Relation<'oneToOne', 'api::lunch.lunch'>;
    publishedAt: Schema.Attribute.DateTime;
    resident: Schema.Attribute.Relation<'manyToOne', 'api::resident.resident'>;
    Seating: Schema.Attribute.Integer;
    slug: Schema.Attribute.UID<'Title'>;
    supper: Schema.Attribute.Relation<'oneToOne', 'api::dinner.dinner'>;
    Title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Resident-Date'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiResidentResident extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Breakfast_preferences: Schema.Attribute.Component<'meals.breakfast', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    Guidelines: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    Lunch_preferences: Schema.Attribute.Component<'staples.preferences', false>;
    menus: Schema.Attribute.Relation<'oneToMany', 'api::menu.menu'>;
    move_out: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    Supper_preferences: Schema.Attribute.Component<
      'staples.preferences',
      false
    >;
    table: Schema.Attribute.Integer &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::breakfast.breakfast': ApiBreakfastBreakfast;
      'api::dinner.dinner': ApiDinnerDinner;
      'api::lunch.lunch': ApiLunchLunch;
      'api::menu-schedule.menu-schedule': ApiMenuScheduleMenuSchedule;
